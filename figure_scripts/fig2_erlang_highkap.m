...
simdata_lin = importdata('sim_data/simdata_erlang_highkap_lin.txt');
simdata_tri = importdata('sim_data/simdata_erlang_highkap_tri.txt');
...
% Import data
ac_struct = importdata('ac_data/ac_erlang_highkap_lin.txt');
...
% Import data
ac_struct = importdata('ac_data/ac_erlang_highkap_tri.txt');
ac = ac_struct.data;
...
%-------------------
 ...
 %Export at 300 dpi 
 print('../../Research/vaccine_behaviour_16/PNAS_demetri/figures/fig2_erlang_highkap','-dpdf','-r300')
