...
% Plot range
xlow=0; xhigh=100; ylow=0.5; yhigh=0.85;
...
% Plot range
xlow=0; xhigh=100; ylow=2e-5; yhigh=8e-5;
axis([xlow xhigh ylow yhigh ])
...
% Plot range
xlow=0; xhigh=100; ylow=0.5e-2; yhigh=1e-2;
axis([xlow xhigh ylow yhigh ])
...
%-------------------
 ...
 %Export at 300 dpi 
 print('../../Research/vaccine_behaviour_16/PNAS_demetri/figures/fig2_highkap_lin','-dpdf','-r300')
