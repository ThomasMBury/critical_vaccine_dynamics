...
simdata_lin = importdata('sim_data/simdata_seasonal_highkap_lin.txt');
simdata_tri = importdata('sim_data/simdata_seasonal_highkap_tri.txt');
...
yyaxis left
plot(t,simdata_lin(:,3*plot_num_lin+2),'b','LineWidth',lw)
axis([-inf,inf,0.5,1])
...
yyaxis right
plot(t,simdata_lin(:,3*plot_num_lin+1),'r','LineWidth',lw)
set(gca,'YColor','r')
...
% Import data
ac_struct = importdata('ac_data/ac_seasonal_highkap_lin.txt');
...
yyaxis left
plot(t,simdata_tri(:,3*plot_num_tri+2),'b','LineWidth',lw)
axis([-inf,inf,0.5,1])
set(gca,'xticklabel',[],'FontSize',fs,'YColor','b')
...
yyaxis right
plot(t,simdata_tri(:,3*plot_num_tri+1),'r','LineWidth',lw)
set(gca,'YColor','r')
axis([-inf,inf,0,4e-3])
% change ticks
ax = gca;
...
% Import data
ac_struct = importdata('ac_data/ac_seasonal_highkap_tri.txt');
ac = ac_struct.data;
...
%-------------------
 ...
 %Export at 300 dpi 
 print('../../Research/vaccine_behaviour_16/PNAS_demetri/figures/fig2_seasonal_highkap','-dpdf','-r300')
