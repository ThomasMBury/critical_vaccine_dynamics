...
simdata_tri2 = importdata('sim_data/simdata_tri.txt');
...
% Import data
sdD_struct = importdata('sd_data/sd_tri.txt');
sdD = sdD_struct.data;
...
% Import data
cov_struct = importdata('cov_data/cov_tri.txt');
cov = cov_struct.data;
...
% Plot range
xlow=0; xhigh=100; ylow=4e-3; yhigh=10e-3;
axis([xlow xhigh ylow yhigh ])
...
%-------------------
 ...
 %Export at 300 dpi 
 print('../../Research/vaccine_behaviour_16/PNAS_demetri/figures/fig2_tri','-dpdf','-r300')
