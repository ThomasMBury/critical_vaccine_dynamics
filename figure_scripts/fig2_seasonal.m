...
simdata_lin = importdata('sim_data/simdata_seasonal_lin.txt');
simdata_tri = importdata('sim_data/simdata_seasonal_tri.txt');
...
% Import data
ac_struct = importdata('ac_data/ac_seasonal_lin.txt');
...
% Import data
ac_struct = importdata('ac_data/ac_seasonal_tri.txt');
ac = ac_struct.data;
...
% Plot range
xlow=0; xhigh=100; ylow=0.4; yhigh=inf;
axis([xlow xhigh ylow yhigh ])
...
%-------------------
 ...
 %Export at 300 dpi 
 print('../../Research/vaccine_behaviour_16/PNAS_demetri/figures/fig2_seasonal','-dpdf','-r300')
